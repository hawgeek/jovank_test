...
const formData = ref({
  ...
  // applicantName: 'qwer',
  // applicantEmail: 'qwer@qwer.com',
  // applicantMobilePhoneNumber: '1231231231',
  // applicantAddress: 'qwer',
  // annualIncomeBeforeTax: 0,
  // incomingAddress: 'qwer',
  // incomingDeposit: 0,
  // incomingPrice: 0,
  // incomingStampDuty: 0,
  // loanAmount: 0,
...
<template>
  <div class="action-section">
    ...
    <BModal :visible="modal.isVisible.value" :confirm="modal.confirm">
      ...
      <form @submit.prevent="submitApplication()" ref="form">
        ...
        <div class="action-container">
          <BButton type="submit" variant="primary" label="Submit" class="btn-submit"></BButton>
